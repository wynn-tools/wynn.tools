...
const FIXTURE_ITEMS = [
  { id: 1, name: 'Warp', displayName: 'Warp', rarity: 'legendary', type: 'wand', subType: 'wand', tier: 'Legendary', level: 80, classRequirement: 'mage', powderSlots: 2, majorIds: [], requirements: {}, identifications: { spellDamage: 30 } },
  { id: 2, name: 'Warchief', displayName: 'Warchief', rarity: 'fabled', type: 'helmet', subType: null, tier: 'Fabled', level: 90, classRequirement: null, powderSlots: 1, majorIds: ['Saviour’s Sacrifice'], requirements: {}, identifications: {} },
  { id: 3, name: 'Boreal Mantle', displayName: 'Boreal Mantle', rarity: 'legendary', type: 'chestplate', subType: null, tier: 'Legendary', level: 75, classRequirement: null, powderSlots: 3, majorIds: [], requirements: {}, identifications: {} },
]
...
describe('discord interactions', () => {
  ...
  it('handles /item with a known name', async () => {
    ...
    expect(json.data.embeds[0].image.url).toContain('/v1/og/item/warp')
  })
